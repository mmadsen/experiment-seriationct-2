#!/bin/sh
#seriationct-export-data.py --experiment seriationct-27 --outputdirectory exported-data
#seriationct-assemblage-duration-export.py --experiment seriationct-27 --outputdirectory temporal
...
seriationct-sample-assemblages-for-seriation.py --inputdirectory sampled-traits --outputdirectory spatial-sampled-data --sampletype spatial --numsamples 5 --samplefraction 0.1 --spatialquadrats 2 --maxsizespatial 1100 --debug 0 --spatialdata xyfiles/seriationct-27XY.txt
seriationct-sample-assemblages-for-seriation.py --inputdirectory sampled-traits --outputdirectory spatiotemporal-sampled-data --sampletype spatiotemporal --numsamples 5 --samplefraction 0.1 --spatialquadrats 2 --maxsizespatial 1100 --debug 0 --spatialdata xyfiles/seriationct-27XY.txt --temporalperiods 3 --temporaldata temporal

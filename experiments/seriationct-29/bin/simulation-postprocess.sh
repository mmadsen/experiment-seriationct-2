#!/bin/sh
seriationct-export-data.py --experiment seriationct-29 --outputdirectory exported-data
seriationct-assemblage-duration-export.py --experiment seriationct-29 --outputdirectory temporal
...
seriationct-sample-assemblages-for-seriation.py --inputdirectory sampled-traits --outputdirectory spatial-sampled-data --sampletype spatial --numsamples 5 --samplefraction 0.1 --spatialquadrats 2 --maxsizespatial 1100 --debug 0 --spatialdata xyfiles/seriationct-29XY.txt
seriationct-sample-assemblages-for-seriation.py --inputdirectory sampled-traits --outputdirectory spatiotemporal-sampled-data --sampletype spatiotemporal --numsamples 5 --samplefraction 0.1 --spatialquadrats 2 --maxsizespatial 1100 --debug 0 --spatialdata xyfiles/seriationct-29XY.txt --temporalperiods 3 --temporaldata temporal
